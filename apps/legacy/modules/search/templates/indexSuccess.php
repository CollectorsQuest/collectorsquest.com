...
<div id="search-tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all" style="margin-top: -5px; margin-right: -5px; background: none; border: none;">
  <ul class="ui-tabs ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
    ...
    <li class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active">
      <a href="#search-tab-collectibles"><?= __('Collectibles'); ?>
        <small>(<?= $totals['collectibles']; ?>)</small>
      </a></li>
    <?php endif; ?>
    <?php if (!empty($collections) && is_array($collections)): ?>
    <li class="ui-state-default ui-corner-top ui-state-active">
      <a href="#search-tab-collections"><?= __('Collections'); ?>
        <small>(<?= $totals['collections']; ?>)</small>
      </a></li>
    <?php endif; ?>
    <?php if (!empty($collectors) && is_array($collectors)): ?>
    <li class="ui-state-default ui-corner-top ui-state-active"><a href="#search-tab-collectors"><?= __('Collectors'); ?>
      <small>(<?= $totals['collectors']; ?>)</small>
    </a></li>
    <?php endif; ?>
    <?php if (!empty($blog) && is_array($blog)): ?>
    <li class="ui-state-default ui-corner-top ui-state-active"><a href="#search-tab-blog"><?= __('Blog Articles'); ?>
      <small>(<?= $totals['blog']; ?>)</small>
    </a></li>
    <?php endif; ?>
    <!--
  ...
  <div id="search-tab-collectibles">
    ...
    include_partial(
      'global/pager',
      array(
        'pager'   => $pagers['collectibles'],
        'options' => array('url' => '@search_collectibles?q=' . $q)
      )
    );
    ?>
  </div>
  ...
  <div id="search-tab-collections">
    ...
    include_partial(
      'global/pager',
      array(
        'pager'   => $pagers['collections'],
        'options' => array('url' => '@search_collections?q=' . $q)
      )
    );
    ?>
  </div>
  ...
  <div id="search-tab-collectors">
    ...
    include_partial(
      'global/pager',
      array(
        'pager'   => $pagers['collectors'],
        'options' => array('url' => '@search_collectors?q=' . $q)
      )
    );
    ?>
  </div>
  ...
  <div id="search-tab-blog">
    ...
    include_partial(
      ...
      array(
        'pager'   => $pagers['blog'],
        'options' => array('url' => '@search_blog?q=' . $q)
      )
    );
    ?>
  </div>
