        ...
        <div id="marketplace" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
          <ul class="ui-tabs ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
            ...
            <li class="ui-state-default ui-corner-top" style="float: right;">
              <a href="#become_seller"><?php echo __('Become a seller') ?></a>
            </li>
            <?php endif; ?>
            <li class="ui-state-default ui-corner-top <?php if (!$isSeller) echo 'ui-tabs-selected ui-state-active' ?>" style="<?php if ($isSeller) echo 'float: right;'; ?>">
              <a href="#collectibles_bought"><?php echo __("Collectibles You've Bought") ?></a>
            </li>
            <li class="ui-state-default ui-corner-top" style="<?php if ($isSeller) echo 'float: right;'; ?>">
              <a href="#collectibles_buying"><?php echo __("Collectibles You're Buying") ?></a>
            </li>
            <?php if ($isSeller): ?>
            <li class="ui-state-default ui-corner-top <?php if ($isSeller) echo 'ui-tabs-selected ui-state-active'; ?>">
              <a href="#collectibles_selling"><?php echo __("Collectibles You're Selling") ?></a>
            </li>
            <li class="ui-state-default ui-corner-top">
              <a href="#collectibles_sold"><?php echo __("Collectibles You've Sold") ?></a>
            </li>
            <?php endif; ?>
          </ul>
          <div id="collectibles_selling" class="<?php if ($isSeller): ?>ui-tabs-panel<?php else: ?>ui-tabs-hide<?php endif; ?>" style="padding-left: 13px;">
            <?php
          ...
          <div id="collectibles_buying" class="ui-tabs-hide">
            <?php
          ...
          <div id="become_seller" class="ui-tabs-hide">
            <?php include_partial('seller/packages', array('plan'=> 1)); ?>
          </div>
        </div>
      </td>
    </tr>
