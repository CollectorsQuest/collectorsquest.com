...
<div id="collectible_<?= $collectible->getId(); ?>_grid_view_3x1"
     data-id="<?= $collectible->getId(); ?>"
     class="span9 collectible_grid_view_3x1 fade-white link">
  ...
  <?php
    echo link_to_collectible($collectible, 'image', array(
      'image_tag' => array('width' => 450, 'height' => 140, 'class' => $lazy_image ? 'lazy' : ''),
