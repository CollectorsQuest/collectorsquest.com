...
<div id="collectible_<?= $collectible->getId(); ?>_grid_view_1x3"
     data-id="<?= $collectible->getId(); ?>"
     class="span3 collectible_grid_view_1x3 fade-white link">
  ...
  <?php
    echo link_to_collectible($collectible, 'image', array(
      'image_tag' => array('width' => 140, 'height' => 450, 'class' => $lazy_image ? 'lazy' : ''),
