...
<?php
  ...
  foreach ($pager->getResults() as $i => $collectible)
  {
    ...
    if ($rand == $i)
    {
      include_partial('marketplace/partials/marketBecomeSellerPromo_194x153_mobile');
    }
    ...
    include_component(
      ...
      array(
        ...
        'options' => array(
          ...
          'url' => url_for('@ajax_marketplace?section=component&page=holidayCollectiblesForSaleMobile'),
          'show_all' => true,
          'page_param' => 'p',
        )
      )
