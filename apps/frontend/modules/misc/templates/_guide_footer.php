<div class="wrapper-bottom">
  <?php
    cq_sidebar_title(
      'Why Should You Join?', null,
      array('class' => 'row-fluid section-title-yellow spacer-bottom-30')
    );
  ?>
  <div class="row-fluid">
    <div class="span4">
      <h4 class="Chivo webfont">Show off your collection!<br/>&nbsp;</h4>
      <p>
    ...
    <div class="span4">
      <h4 class="Chivo webfont">Sell your antiques and collectibles!</h4>
      <p>
    ...
    <div class="span4">
      <h4 class="Chivo webfont">Meet other members!<br/>&nbsp;</h4>
      <p>
