...
<div class="alert alert-error in" data-alert="alert">
  <a class="close" data-dismiss="alert">×</a>
  <?= implode('<br><br>', array_filter((array) $sf_user->getFlash('error'))); ?>
</div>
...
<div class="alert">
  <?= has_slot('flash_highlight') ? get_slot('flash_highlight') : $sf_user->getFlash('highlight'); ?>
</div>
<?php endif; ?>
