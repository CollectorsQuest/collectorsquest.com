...
class PayPal
{
  ...
  function MassPay($DataArray)
  {
    ...
    foreach ($MPItems as $MPItemsVar => $MPItemsVal)
    {
      ...
      {
        $MPItemsNVP .= $CurrentItemVar != '' ? '&' . strtoupper($CurrentItemVar) . $n . '=' . urlencode($CurrentItemVal) : '';
      }
      $n++;
    }
...
class PayPal_Adaptive extends PayPal
{
  ...
  function GetPaymentOptions($PayKey)
  {
    ...
    /** @var $RequireShippingAddressSelection DOMElement[]  */
    ...
    /** @var $ReceiverOptions DOMElement[] */
