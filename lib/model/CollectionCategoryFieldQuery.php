...
/**
 * Skeleton subclass for performing query and update operations on the 'collection_category_field' table.
 *
 * 
 *
...
class CollectionCategoryFieldQuery extends BaseCollectionCategoryFieldQuery {
	...
	public static function create($modelAlias = null, $criteria = null)
	{
		...
		$query = new self('propel', 'CollectionCategoryField', $modelAlias);
