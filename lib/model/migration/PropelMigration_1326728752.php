...
class PropelMigration_1326728752
{
  /**
  ...
  {
    return array('archive' => "
      DROP TABLE `collector_profile_archive`;
      DROP TABLE `collector_identifier_archive`;
      DROP TABLE `collector_geocache_archive`;
      DROP TABLE `collector_archive`;
      DROP TABLE `collection_archive`;
      DROP TABLE `collectible_offer_archive`;
      DROP TABLE `collectible_for_sale_archive`;
      DROP TABLE `collectible_archive`;
      DROP TABLE IF EXISTS `comment_archive`;
      DROP TABLE `multimedia_archive`;
    ");
  }
}
