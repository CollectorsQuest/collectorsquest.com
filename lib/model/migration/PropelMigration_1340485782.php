  ...
  public function getUpSQL()
  {
    return array (
      'propel' => '
        ...
        CHANGE `shipping_country_iso3166` `shipping_country_iso3166` CHAR(2) NOT NULL;

        ALTER TABLE `shopping_cart_collectible`
        CHANGE `shipping_fee_amount` `shipping_fee_amount` INTEGER;

        ALTER TABLE `shopping_cart_collectible`
        ADD `shipping_type` TINYINT AFTER `shipping_fee_amount`;
