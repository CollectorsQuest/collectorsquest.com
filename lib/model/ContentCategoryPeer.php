...
class ContentCategoryPeer extends BaseContentCategoryPeer
{
  ...
  const PROPERTY_SEO_COLLECTIONS_DESCRIPTION   = 'SEO_COLLECTIONS_DESCRIPTION';
  const PROPERTY_SEO_COLLECTIONS_KEYWORDS      = 'SEO_COLLECTIONS_KEYWORDS';
  ...
  const PROPERTY_SEO_MARKET_DESCRIPTION   = 'SEO_MARKET_DESCRIPTION';
  const PROPERTY_SEO_MARKET_KEYWORDS      = 'SEO_MARKET_KEYWORDS';
