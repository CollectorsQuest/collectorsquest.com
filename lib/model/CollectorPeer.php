...
class CollectorPeer extends BaseCollectorPeer
{
  ...
  const PROPERTY_SELLER_SETTINGS_SHIPPING_US_TYPE = 'SELLER_SETTINGS_SHIPPING_US_TYPE';
  const PROPERTY_SELLER_SETTINGS_SHIPPING_US_RATE = 'SELLER_SETTINGS_SHIPPING_US_RATE';

  const PROPERTY_SELLER_SETTINGS_SHIPPING_INTERNATIONAL_TYPE = 'SELLER_SETTINGS_SHIPPING_INTERNATIONAL_TYPE';
  const PROPERTY_SELLER_SETTINGS_SHIPPING_INTERNATIONAL_RATE = 'SELLER_SETTINGS_SHIPPING_INTERNATIONAL_RATE';
  const PROPERTY_SELLER_SETTINGS_SHIPPING_INTERNATIONAL_EXCLUDE = 'SELLER_SETTINGS_SHIPPING_INTERNATIONAL_EXCLUDE';
