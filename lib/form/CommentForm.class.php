...
class CommentForm extends BaseCommentForm
{
  ...
  public function doSave($con = null)
  {
    ...
    if ($is_authenticated)
    {
      $array['collector_id'] = $sf_user->getId();
    }
    else if ($is_facebook_authenticated)
    {
      $array['facebook_id']  = $sf_user->getFacebookId();
      $array['author_name']  = $sf_user->getName();
      $array['author_email'] = $sf_user->getEmail();
      $array['author_url']   = $sf_user->getWebsiteUrl();
    }
    else
    {
