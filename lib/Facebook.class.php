...
class Facebook 
{
  ...
  public function getLoginUrl($params=array()) {
    ...
    return $this->getUrl(
            'www', 'login.php', array_merge(array(
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if (curl_errno($ch) == 60) 
    {
      ...
      curl_setopt($ch, CURLOPT_CAINFO, dirname(__FILE__) . '/../../data/facebook_ca_chain_bundle.crt');
      $result = curl_exec($ch);
    }
  ...
  protected function validateSessionObject($session) 
  {
    ...
    if (is_array($session) &&
      ...
      $expected_sig = self::generateSignature(
                      $session_without_sig, $this->getApiSecret()
      );
