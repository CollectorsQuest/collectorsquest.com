<?php
/**
 *   Angell EYE PayPal Adaptive Payments Library
...
class PayPalAdaptivePayments extends PayPal
{
   ...
   * @return  string
   */
  function CURLRequest($Request, $APIName = null, $APIOperation = null)
  {
    $curl = curl_init();
  ...
  function GetInvoiceDetails($InvoiceID)
  {
    // Generate XML Request
    $XMLRequest = '<?xml version="1.0" encoding="utf-8"?>';
    $XMLRequest .= '<GetInvoiceDetails xmlns="' . $this->XMLNamespace . '">';
    $XMLRequest .= $this->GetXMLRequestEnvelope();
    $XMLRequest .= $InvoiceID != '' ? '<invoiceID xmlns="">' . $InvoiceID . '</invoiceID>' : '';
    $XMLRequest .= '</GetInvoiceDetails>';
