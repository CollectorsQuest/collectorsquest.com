...
class MailChimp
{
     ...
     */
    function MailChimp($apikey, $secure=false) {
        $this->secure = $secure;
    ...
    */
     ...
     * @return boolean true on success, false on failure. When using MailChimp.class.php, the value can be tested and error messages pulled from the MailChimp object (see below)
     */
     ...
     * @return boolean true on success, false on failure. When using MailChimp.class.php, the value can be tested and error messages pulled from the MailChimp object
     */
    ...
    function callServer($method, $params) {
        ...
        $payload .= "Host: " . $host . "\r\n";
        $payload .= "User-Agent: MailChimp/" . $this->version ."\r\n";
