...
/**
 * Updates the value of a SimpleCalculations column
 *
 * @param string      $column The column name (in TYPE_PHPNAME by default)
 * @param integer     $updateBy What number to update the column by (positive or negative)
 ...
 */
public function updateColumn($column, $updateBy, $andSave = false, $columnFieldnameType = BasePeer::TYPE_PHPNAME, PropelPDO $con = null)
{
    ...
    $getter = 'get' . $colPhpName;

    $this->$setter(
        $this->$getter() + (int) $updateBy
    );
