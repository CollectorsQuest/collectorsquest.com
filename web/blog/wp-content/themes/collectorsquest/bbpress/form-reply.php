			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_reply_submit" name="bbp_reply_submit" class="button submit btn btn-primary"><?php _e( 'Submit', 'bbpress' ); ?></button>
...
<!--<script src="/js/assets/js/wysihtml5.js"></script>
<script src="/js/assets/js/bootstrap/wysihtml5.js"></script>
