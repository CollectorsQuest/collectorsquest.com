...
if(!class_exists('Services_PRJSON'))
  require_once('JSON/PRJSON.php');
global $postrank_json;
$postrank_json = new Services_PRJSON(SERVICES_PRJSON_LOOSE_TYPE);
...
function postrank_check_import()
{
  ...
  global $postrank_messages;
  $postrank_messages[] = 'Your feed has been added to our system.  Don\'t despair, PostRanks will be appearing shortly!  If they still haven\'t turned up after several hours, go ahead and contact us at <a href="http://help.postrank.com">PostRank Support</a>';
}
...
function dashboard_widget_postrank_init()
{
  ...
  {
    ?>
    <iframe id="postrank-dashboard-widget" src="<?php echo POSTRANK_ANALYTICS_HOST ?>/wordpress_summary/<?php echo get_option('postrank_feed_hash'); ?>" style="width:100%; height: 220px;" frameborder="0">
    </iframe>
    <?php
  }
...
function postrank_options()
{
  ...
  <span class="setting-description"><?php _e('If something is not working with the plugin, let us know at <a href="http://help.postrank.com">PostRank Support</a>, and we\'ll help you figure out what to put here.'); ?></span>
  </td>
  </tr>
