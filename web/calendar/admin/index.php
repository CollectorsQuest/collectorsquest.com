...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr>
		<td class="topMenu">&nbsp;</td>
		<td width="760" valign="top" class="topMenu" height="21">
			
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td colspan="3" width="760" class="main"><?include(HC_AdminMenu);?></td>
				</tr>
				<tr>
					<td width="580" class="main" style="padding-left:5px;padding-top:15px;" valign="top">
					...
					<td width="170" class="main" valign="top" align="center">
						<img src="<?echo CalAdminRoot;?>/images/cq_logo.gif" width="128" height="88" alt="" border="0" style="border: 1px solid black; margin-top: 5px;">
						<br><br>
						...
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="180" height="200" align="center" class="main" style="background-color: #EFEFEF; border: solid #BDBDBD 1px;">
									<img src="<?echo CalAdminRoot;?>/images/cq_logo.gif" width="128" height="88" alt="" border="0" style="border: 1px solid black;"><br>
