...
<?	}//end if
			...
			<td class="eventMain">
				<?php
					...
					$regAvailable = $maxRegistration;
						...
						?>
							<img src="<?echo CalRoot;?>/images/reg-overflow.gif" width="100" height="7" alt="" border="0" style="border-left: solid #000000 0.5px; border-right: solid #000000 0.5px;">
						<?
					...
					<br><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="5" alt="" border="0"><br>
					 <a href="<?echo CalAdminRoot;?>/index.php?com=eventregister&eID=<?echo $eID;?>" class="main">Click to View/Add Registrants</a>
			</td>
		</tr>
	<?
	}//end if
	?>
			...
			<td class="eventMain">
				...
				<?	$query = "	SELECT " . HC_TblPrefix . "categories.*, " . HC_TblPrefix . "eventcategories.EventID
					...
					while($row = mysql_fetch_row($result)){
						...
						?>
							<td class="eventMain"><input <?if($row[7] != ''){echo "checked";}//end if?> type="checkbox" name="catID[]" id="catID_<?echo $row[0];?>" value="<?echo $row[0];?>"></td>
		...
		<tr><td colspan="2"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="7" alt="" border="0"></td></tr>
		<tr>
			<td class="eventMain" width="80">Postal Code:</td>
			<td class="eventMain">
					...
					<tr>
						...
						<td>
							<?php
								if($contactURL != "http://"){
							?>
								&nbsp;<a href="<?echo $contactURL?>" class="main" target="_blank"><img src="<?echo CalAdminRoot;?>/images/icons/iconWebsite.gif" width="20" height="20" alt="" border="0"></a>
							<?php
								} else {
							?>
								&nbsp;
