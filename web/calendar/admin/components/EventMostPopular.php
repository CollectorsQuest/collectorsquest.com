		...
		<?
			...
			while($row = mysql_fetch_row($result)){
				...
				<tr>
					...
					<td class="eventMain" <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?> align="right"><?echo cOut($viewCount);?></td>
