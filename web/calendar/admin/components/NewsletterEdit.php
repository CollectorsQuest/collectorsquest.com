			...
			<td valign="top">
				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
					<tr>
						...
						<td><input size="49" maxlength="250" type="text" name="tempname" id="tempname" value="<?echo cOut($name);?>" class="input"></td>
					</tr>
					<tr><td colspan="2"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
					<tr>
						<td colspan="2"><textarea name="tempsource" id="tempsource" rows="25" cols="63" class="input"><?echo cOut($source);?></textarea></td>
					</tr>
					<tr><td colspan="2"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
					<tr>
						<td colspan="2">
...
function templatePreview(pID){
	...
	if(hasRows($result)){
			...
			?>
				<tr>
					<td class="eventMain" <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?> width="200"><?echo cOut($row[1])?></td>
					<td class="eventMain" <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?> width="20"><a href="javascript:;" onClick="templatePreview('<?echo $row[0];?>');" class="main" title="Preview Template"><img src="<?echo CalAdminRoot;?>/images/icons/iconView.gif" width="15" height="15" alt="" border="0" title="Preview Template"></a></td>
					<td class="eventMain" <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?> width="20"><a href="<?echo CalAdminRoot;?>/index.php?com=newsletteredit&nID=<?echo cOut($row[0]);?>" class="main" title="Edit Template"><img src="<?echo CalAdminRoot;?>/images/icons/iconEdit.gif" width="15" height="15" alt="" border="0" title="Edit Template"></a></td>
					<td class="eventMain" <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?>><a href="javascript:doDelete('<?echo cOut($row[0]);?>');" class="main" title="Delete Template"><img src="<?echo CalAdminRoot;?>/images/icons/iconDelete.gif" width="15" height="15" alt="" border="0" title="Delete Template"></a></td>
				</tr>
