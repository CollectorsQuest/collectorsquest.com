...
<?php 
	...
	$result = doQuery("SELECT SettingValue FROM " . HC_TblPrefix . "settings WHERE PkID IN (1,2,3,4,8,9,10,11,12,13,14,15,21) ORDER BY PkID");
	...
	$format = cOut(mysql_result($result,10,0));
	$showTime = cOut(mysql_result($result,11,0));
	$state = cOut(mysql_result($result,12,0));
	
	if($passApprove == ''){
		$passApprove = "Your event has been approved and is now available on our website. I hope you continue to use our calendar and submit more events in the future. Thank you for using our calendar and if you have any questions please feel free to contact me.";
	}//end if
	
	if($passDecline == ''){
		$passDecline = "Your event has been declined and will not be available on our website. Please do not let this discourage you from submiting more events in the future. Thank you for using our calendar and if you have any questions please feel free to contact me.";
	}//end if
?>
<br>
...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td colspan="2"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
	<tr>
		<td class="eventMain">Default Country:</td>
		<td>
			<?include('../events/includes/selectCountry.php');?>
		</td>
	</tr>
	<tr><td colspan="2"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="10" alt="" border="0"></td></tr>
	<tr>
		<td colspan="2" class="eventMain">Approve Event Default Message:</td>
	</tr>
	<tr><td colspan="2"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
	<tr>
		<td colspan="2">
			<textarea autocomplete="off" style="width: 99%; height: 125px" id="defaultApprove" name="defaultApprove" class="input"><?echo $passApprove;?></textarea>
		</td>
	</tr>
	<tr><td colspan="2"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="10" alt="" border="0"></td></tr>
	<tr>
		<td colspan="2" class="eventMain">Decline Event Default Message:</td>
	</tr>
	<tr><td colspan="2"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
	<tr>
		<td colspan="2">
			<textarea autocomplete="off" style="width: 99%; height: 125px" id="defaultDecline" name="defaultDecline" class="input"><?echo $passDecline;?></textarea>
		</td>
	</tr>
	<tr><td colspan="2"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
