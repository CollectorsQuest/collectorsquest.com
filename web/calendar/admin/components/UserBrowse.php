					...
					<?php
						...
						?>
							...
							<tr>
								...
								<td <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?> align="right"><a href="<?echo CalAdminRoot;?>/?com=useredit&uID=<?echo cOut($row[0]);?>" class="main" title="Edit User"><img src="<?echo CalAdminRoot;?>/images/icons/iconEdit.gif" width="15" height="15" title="Edit User" alt="" border="0"></a>&nbsp;&nbsp;</td>
								<td <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?>><a href="javascript:;" onclick="javascript:doDelete('<?echo cOut($row[0]);?>'); return false;" class="main" title="Delete User"><img src="<?echo CalAdminRoot;?>/images/icons/iconDelete.gif" width="15" height="15"  title="Delete User" alt="" border="0"></a>&nbsp;</td>
							</tr>
							<tr><td colspan="4" <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?>><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="1" alt="" border="0"></td></tr>
						<?
							$cnt++;
