...
<?php 
	...
	if(isset($_GET['eID'])){
		...
		?>
			...
			<input type="hidden" name="eventTitle" id="eventTitle" value="<?echo cOut(mysql_result($resulte,0,1));?>">
			...
			?>
				...
				<tr>
					...
					<td>
						<select name="eventStatus" id="eventStatus" class="input" >
							...
							<option value="2">Duplicate -- Thank User and Remove</option>
						</select>
					</td>
				</tr>
				<tr><td colspan="2"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="7" alt="" border="0"></td></tr>
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td align="right"><input type="checkbox" name="sendmsg" id="sendmsg" checked ></td>
								<td class="eventMain"><label for="sendmsg" class="button">Send Email Confirmation Message to: <?echo cOut(mysql_result($resulte,0,20));?> (<?echo cOut(mysql_result($resulte,0,21));?>)</label></td>
							</tr>
						</table>
					</td>
				</tr>
