...
if(hasRows($result)){
	...
	<?php
		appInstructions(0, "Billboard_Events", "Billboard Events", "<img src=\"" . CalAdminRoot . "/images/icons/iconEdit.gif\" width=\"15\" height=\"15\" alt=\"\" border=\"0\"> = Edit Event<br><img src=\"" . CalAdminRoot . "/images/icons/iconDelete.gif\" width=\"15\" height=\"15\" alt=\"\" border=\"0\"> = Remove Event From Billboard");
	?>
	...
	<?php
		...
		?>
			<tr>
				...
				<td class="eventMain" <?if($cnt % 2 == 0){echo "bgcolor=\"#EEEEEE\"";}//end if?> align="right"><a href="<?echo CalAdminRoot;?>/index.php?com=eventedit&eID=<?echo $row[0];?>" class="main" title="Edit Event"><img src="<?echo CalAdminRoot;?>/images/icons/iconEdit.gif" width="15" height="15" alt="" border="0"></a>&nbsp;&nbsp;</td>
				<td class="eventMain" <?if($cnt % 2 == 0){echo "bgcolor=\"#EEEEEE\"";}//end if?>><a href="javascript:doDelete('<?echo $row[0];?>');" class="main" title="Remove From Billboard"><img src="<?echo CalAdminRoot;?>/images/icons/iconDelete.gif" width="15" height="15" alt="" border="0"></a></td>
