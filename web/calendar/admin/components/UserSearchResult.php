...
<?php
	appInstructions(1, "Newsletter_Recipients", "Newsletter Recipient Search Results", "Select an alert recipient from below to edit or delete.");
?>
<br>
