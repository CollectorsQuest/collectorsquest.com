...
?>
<script language="JavaScript" src="/cal/events/includes/color_picker.js" ></script>
	...
	<tr>
		<td width="45%" valign="top">
			...
			<table cellpadding="0" cellspacing="0" border="0">
				...
				<tr><td colspan="3"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="4" alt="" border="0"></td></tr>
				 <tr>
                                        <td width="50" class="eventMain">Color:</td>
                                        <td>
						<table cellpadding="0" cellspacing="0" border="0">
                                                <tr><td><input type="text" size="10" name="color" id="color" value="<?echo $color;?>" class="input" onchange="javascript:change_bg('cat_color_cell',this.value);"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="3" height="1" alt="" border="0"></td>
						<td id="cat_color_cell" style="border: 1px solid black; background: <?echo $color;?>;"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="55" height="1" alt="" border="0"></td>
						<td><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="3" height="1" alt="" border="0"><a href="javascript:TCP.popup(document.forms['frm'].elements['color'],0);" ><img border="0" src='images/palette.gif'></a></td>
						</table>
                                        </td>
                                        <td><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="5" height="1" alt="" border="0"></td>
		...
		<td width="200" class="eventMain" valign="top">
			<?	$result = doQuery("SELECT PkID, CategoryName,Color FROM " . HC_TblPrefix . "categories WHERE IsActive = 1 ORDER BY CategoryName");
				if(hasRows($result)){
					?>
					...
					<?php
						...
						while($row = mysql_fetch_row($result)){
							if($curCat != $row[0]){
						?>
							<tr><td colspan="6" <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?>><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="1" alt="" border="0"></td></tr>
							<tr>
								<td class="eventMain" <?if($cnt % 2 == 1){echo "bgcolor=\"#EEEEEE\"";}//end if?>>&nbsp;<?if($cID == $row[0]){echo "<b>" . cOut($row[1]) . "</b>";} else {echo cOut($row[1]);}//end if?></td>
								<td><img src="<?echo CalRoot;?>/images/color_image.php?width=20&height=10&color=<?echo urlencode($row[2]);?>" style="border: 1px solid black; margin-right: 3px; margin-left: 3px;" border=0></td>
					...
					?>
						...
						<tr><td colspan="6"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="1" height="7" alt="" border="0"></td></tr>
						<tr><td colspan="6" class="eventSeparator"><img src="<?echo CalAdminRoot;?>/images/spacer.gif" width="100%" height="1" alt="" border="0"></td></tr>
					</table>
				<?
				} else {
