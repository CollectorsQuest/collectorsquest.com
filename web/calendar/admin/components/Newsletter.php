					...
					<td colspan="2">
						...
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td class="eventMain">&nbsp;<a href="javascript:;" onclick="calx.select(document.forms[0].startDate,'anchor1','MM/dd/yyyy'); return false;" name="anchor1" id="anchor1"><img src="<?echo CalAdminRoot;?>/images/datepicker/cal.gif" width="16" height="16" border="0" alt=""></a></td>
								...
								<td>&nbsp;<a href="javascript:;" onclick="calx.select(document.forms[0].endDate,'anchor2','MM/dd/yyyy'); return false;" name="anchor2" id="anchor2"><img src="<?echo CalAdminRoot;?>/images/datepicker/cal.gif" width="16" height="16" border="0" alt=""></a></td>
							</tr>
						</table>
