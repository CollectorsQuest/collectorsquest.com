...
function TCPopup(field, palette) {
	...
	o_colWindow = window.open('/cal/events/includes/color_picker.html', null, "help=no,status=no,scrollbars=no,resizable=no" + move + ",width=" + w + ",height=" + h + ",dependent=yes", true);
...
function TCSelect(c) {
	...
	change_bg('cat_color_cell',this.field.value);
	this.win.close();
}
