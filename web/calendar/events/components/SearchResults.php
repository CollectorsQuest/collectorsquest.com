					...
					<tr>
						...
						<td class="eventListHL">
						 <?php
                                        ...
                                        ?>
							<a class="eventActual" href="<?echo CalRoot;;?>/index.php?com=detail&eID=<?echo $row[0];?>" class="eventMain" target="_blank"><img align="absmiddle" src="<?echo CalRoot; ?>/images/color_image.php?width=20&height=12&color=<?echo $urlcolor;?>" border=0 title="<?echo $row[1];?>" alt="<?echo $row[1];?>" class="categorybox"><?echo cOut($row[1]);?></a>
						</td>
					</tr>
			<?
				}//end if
