		...
		<td class="eventMain">
			<?php
				...
				<img src="<?echo CalRoot;?>/images/spacer.gif" width="1" height="5" alt="" border="0"><br>
					...
					<br>
					<table cellpadding="0" cellspacing="0" border="0" width="100%">
					<tr><td><b>Type of Event</b></td></tr>
					<tr><td>
						 <?php
                                                $query = "SELECT PkID,CategoryName,Color from " . HC_TblPrefix . "categories LEFT JOIN " . HC_TblPrefix . "eventcategories ON (" . HC_TblPrefix . "eventcategories.CategoryID = " . HC_TblPrefix . "categories.PkID) WHERE EventID='" . $eID . "'";
                                                $cat_result = doQuery($query);
                                                while($cat_row = mysql_fetch_row($cat_result)) {
                                                        $color = $cat_row[2];
                                                        $urlcolor = urlencode($color);
                                                        $category = $cat_row[1];
                                                        $catid = $cat_row[0];
                                                        ?><img align="absmiddle" src="<?echo CalRoot; ?>/images/color_image.php?width=20&height=12&color=<?echo $urlcolor;?>" border="0" class="categorybox"><?echo $category; ?><br>
                                                <?
                                                }  // end while
                                        ?>
					...
					<table cellpadding="0" cellspacing="0" border="0" width="100%">
						<tr>
							<td class="eventMain" width="50%" valign="top">
								...
								<?php
									...
									?>
										<img src="<?echo CalRoot;?>/images/meter/overflow.gif" width="100" height="7" alt="" border="0">
									<?
									} else {
										...
										?>
											<img src="<?echo CalRoot;?>/images/meter/full.gif" width="<?echo $regWidth;?>" height="7" alt="" border="0" style="border-left: solid #000000 0.5px;"><img src="<?echo CalRoot;?>/images/meter/empty.gif" width="<?echo $fillWidth;?>" height="7" alt="" border="0" style="border-right: solid #000000 0.5px;">
									<?
										}//end if
									}//end if
								?>
							...
							?>
								...
								<table cellpadding="0" cellspacing="0" border="0">
									<tr>
										<td class="main" width="50"><b>Contact</b></td>
										<td>
										<?	if(mysql_result($result,0,14) != '' || mysql_result($result,0,13) != ''){?>
											<a href="<?echo CalRoot;?>/link/SaveContact.php?eID=<?echo mysql_result($result,0,0);?>" title="Download Event Contact vCard"><img src="<?echo CalRoot;?>/images/icons/iconContact.gif" width="15" height="13" alt="" border="0"></a>
										<?	}//end if?>
										</td>
									</tr>
								</table>
													...
													<?	if(mysql_result($result,0,14) != '' || mysql_result($result,0,13) != ''){?>
															...
															<?if(mysql_result($result,0,14) != ''){?>
																...
																?>
																	...
																	document.write('Email: <a href="mailto:' + ename + '@' + edomain + '" class="eventMain">' + ename + '@' + edomain + '</a><br>');
																</script>
															<?}//end if
														}//end if
						...
						<?	}//end if ?>
							...
							<?	if(mysql_result($result,0,25) == 1){?>
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td width="25"><img src="<?echo CalRoot;?>/images/icons/iconRegister.gif" width="16" height="16" alt="" border="0"></td>
											<?if(mysql_result($result,0,26) <= mysql_result($result2,0,0) AND mysql_result($result,0,26) > 0){?>
												<td class="eventMain"><b>Event Full</b><br><a href="<?echo CalRoot;?>/index.php?com=register&eID=<?echo $eID;?>&wID=1" class="eventMain">Overflow Registration Only</a></td>
											<?} else {?>
							...
							<?	if($showDrive == 1){
								?>
									...
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td width="25"><img src="<?echo CalRoot;?>/images/icons/iconGlobe.gif" width="16" height="16" alt="" border="0"></td>
							...
							<?}//end if?>
								...
								<br>
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td width="25"><img src="<?echo CalRoot;?>/images/icons/iconDownload.gif" width="16" height="16" alt="" border="0"></td>
											<td><a href="<?echo CalRoot;?>/link/SaveEvent.php?eID=<?echo mysql_result($result,0,0);?>" class="eventMain">Download This Event</a></td>
										</tr>
									</table>
								...
								<br>
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td width="25"><img src="<?echo CalRoot;?>/images/icons/iconEmail.gif" width="16" height="16" alt="" border="0"></td>
							...
							<?	if(mysql_result($result,0,7) != ''){?>
								<br>
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td width="25"><img src="<?echo CalRoot;?>/images/icons/iconWeather.gif" width="16" height="16" alt="" border="0"></td>
