...
?>
		<table cellpadding="0" cellspacing="0" border="0">
			...
			<tr><td colspan="2" class="eventSubmitSeparator"><img src="<?echo CalRoot;?>/images/spacer.gif" width="100%" height="1" alt="" border="0"></td></tr>
			...
			<tr>
				...
				<td class="eventMain">
					<?php
						echo "[ Recipient Name ],<br><br> I was visiting the " . CalName . " today and found a post for the <b>" . cOut(mysql_result($result,0,1)) . "</b> event and thought you'd like to know about it.<br><br>You can get all the information about it at:<br><a href=\"" . CalRoot . "/index.php?com=detail&eID=" . $eID . "\" target=\"_new\" class=\"eventMain\">" . CalRoot . "/index.php?com=detail&eID=" . $eID . "</a>";
					?>
					<br><br>
