...
{ //class in session
	...
	function setStyles()
	{
		...
		if ($this->tableBorder > 0){
			$this->styleTable = sprintf(" style=\"width: 200px; margin-left: 13px; background-color: %s;border-top: %spx solid %s; border-left: %spx solid %s; border-right: %spx solid %s;\"", $this->tableColor, $this->tableBorder, $this->tableBorderColor, $this->tableBorder, $this->tableBorderColor, $this->tableBorder, $this->tableBorderColor);
