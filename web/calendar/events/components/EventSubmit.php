...
*/
	...
	?>
			...
			warn = "Event could not be added for the following reason(s):";
				...
				} else if(document.eventSubmit.eventDate.value == ''){
					dirty = 1;
				...
				if(document.eventSubmit.recurCheck.checked){
					...
					} else if(document.eventSubmit.recurEndDate.value == ''){
						dirty = 1;
						warn = warn + '\n*Event Recur End Date is Required';
					} else if(document.eventSubmit.recurEndDate.value.length < 10) {
						dirty = 1;
						warn = warn + '\n*Event Recur Date Must Include Leading 0\'s (MM/DD/YYYY)';
					} else if(compareDates(document.eventSubmit.eventDate.value, 'MM/d/yyyy', document.eventSubmit.recurEndDate.value, 'MM/d/yyyy') == 1){
						dirty = 1;
...
<input type="hidden" name="eventRegistration" id="eventRegistration" value="0">
								...
								<td class="eventMain">
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											...
											<td>&nbsp;<a href="javascript:;" onclick="calx.select(document.eventSubmit.eventDate,'anchor1','MM/dd/yyyy'); return false;" name="anchor1" id="anchor1"><img src="<?echo CalRoot;?>/images/datepicker/cal.gif" width="16" height="16" border="0" alt=""></a>&nbsp;</td>
										</tr>
									</table>
								</td>
								<td width="20"><img src="<?echo CalRoot;?>/images/spacer.gif" width="1" height="1" alt="" border="0"></td>
							</tr>
							<tr><td colspan="2"><img src="<?echo CalRoot;?>/images/spacer.gif" width="1" height="7" alt="" border="0"></td></tr>
							<tr>
								...
								<td class="eventMain">
									<table cellpadding="1" cellspacing="0" border="0">
										<tr>
											...
											<td class="eventMain"><a href="javascript:;" onClick="chngClock(document.eventSubmit.startTimeHour,1,12)"><img src="<?echo CalRoot;?>/images/time_up.gif" width="16" height="8" alt="" border="0"></a><br><a href="javascript:;" onClick="chngClock(document.eventSubmit.startTimeHour,-1,12)"><img src="<?echo CalRoot;?>/images/time_down.gif" width="16" height="9" alt="" border="0"></a></td>
											<td class="eventMain"><input size="2" maxlength="2" type="text" name="startTimeMins" id="startTimeMins" value="00" class="eventInput"></td>
											<td class="eventMain"><a href="javascript:;" onClick="chngClock(document.eventSubmit.startTimeMins,1,59)"><img src="<?echo CalRoot;?>/images/time_up.gif" width="16" height="8" alt="" border="0"></a><br><a href="javascript:;" onClick="chngClock(document.eventSubmit.startTimeMins,-1,59)"><img src="<?echo CalRoot;?>/images/time_down.gif" width="16" height="9" alt="" border="0"></a></td>
											<td class="eventMain">
								...
								<td class="eventMain">
									<table cellpadding="1" cellspacing="0" border="0">
										<tr>
											...
											<td class="eventMain"><a href="javascript:;" onClick="chngClock(document.eventSubmit.endTimeHour,1,12)"><img src="<?echo CalRoot;?>/images/time_up.gif" width="16" height="8" alt="" border="0"></a><br><a href="javascript:;" onClick="chngClock(document.eventSubmit.endTimeHour,-1,12)"><img src="<?echo CalRoot;?>/images/time_down.gif" width="16" height="9" alt="" border="0"></a></td>
											<td class="eventMain"><input size="2" maxlength="2" type="text" name="endTimeMins" id="endTimeMins" value="00" class="eventInput"></td>
											<td class="eventMain"><a href="javascript:;" onClick="chngClock(document.eventSubmit.endTimeMins,1,59)"><img src="<?echo CalRoot;?>/images/time_up.gif" width="16" height="8" alt="" border="0"></a><br><a href="javascript:;" onClick="chngClock(document.eventSubmit.endTimeMins,-1,59)"><img src="<?echo CalRoot;?>/images/time_down.gif" width="16" height="9" alt="" border="0"></a></td>
											<td class="eventMain">
					...
					<td class="eventMain">
						...
						<table cellpadding="0" cellspacing="0"  border="0">
							<tr>
								...
								<td class="eventMain"><label for="recurCheck">Check if this is a recurring event.</label></td><td>&nbsp;</td>
							</tr>
							<tr>
								<td colspan="2">
								<img src="<?echo CalRoot;?>/images/spacer.gif" width="1" height="5" alt="" border="0"><br>
										<table cellpadding="0" cellspacing="0" border="0">
											<tr>
												<td valign="top">
												<img src="<?echo CalRoot;?>/images/spacer.gif" width="1" height="1" alt="" border="0"><br>
													<table cellpadding="0" cellspacing="0" border="0">
														<tr>
												...
												<td width="5">&nbsp;</td>
												<td valign="top">
													<img src="<?echo CalRoot;?>/images/spacer.gif" width="1" height="1" alt="" border="0" name="recurSpacer"><br></td>
											</tr>
										</table>
										...
										<table cellpadding="0" cellspacing="0" border="0">
											<tr>
												...
												<td>&nbsp;<a href="javascript:;" onclick="calx.select(document.eventSubmit.recurEndDate,'anchor2','MM/dd/yyyy'); return false;" name="anchor2" id="anchor2"><img src="<?echo CalRoot;?>/images/datepicker/cal.gif" width="16" height="16" border="0" alt=""></a></td>
											</tr>
										</table>
										<td><div id="daily" style="visibility: hidden;">
                        <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                        <td valign="top" class="eventSubmit"><input style="margin: 3px;" type="radio" name="dailyOptions" id="recDaily1" checked="checked" value="EveryXDays"></td>
                                ...
                                <tr>
                                        <td class="eventMain"><input style="margin: 3px;" type="radio" name="dailyOptions" id="recDaily2" value="WeekdaysOnly"></td>
                                        <td class="eventMain" colspan="3"><label for="recDaily2">All Weekdays</label></td>
                                </tr>
                        </table>
			</div>
									 	<div id="weekly" style="visibility: hidden;">
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
				...
				<tr>
					<td class="eventMain"><input style="margin: 3px;"id="recWeeklyDay1" name="recWeeklyDay1" type="checkbox"></td>
					<td class="eventMain"><label for="recWeeklyDay1">Sun</label></td>
					<td class="eventMain"><input style="margin: 3px;" id="recWeeklyDay2" name="recWeeklyDay2" type="checkbox"></td>
					<td class="eventMain"><label for="recWeeklyDay2">Mon</label></td>
					<td class="eventMain"><input style="margin: 3px;" id="recWeeklyDay3" name="recWeeklyDay3" type="checkbox"></td>
					<td class="eventMain"><label for="recWeeklyDay3">Tue</label></td>
					<td class="eventMain"><input style="margin: 3px;" id="recWeeklyDay4" name="recWeeklyDay4" type="checkbox"></td>
					<td class="eventMain"><label for="recWeeklyDay4">Wed</label></td>
				</tr>
				<tr>
					<td class="eventMain"><input style="margin: 3px;" id="recWeeklyDay5" name="recWeeklyDay5" type="checkbox"></td>
					<td class="eventMain"><label for="recWeeklyDay5">Thu</label></td>
					<td class="eventMain"><input style="margin: 3px;" id="recWeeklyDay6" name="recWeeklyDay6" type="checkbox"></td>
					<td class="eventMain"><label for="recWeeklyDay6">Fri</label></td>
					<td class="eventMain"><input style="margin: 3px;" id="recWeeklyDay7" name="recWeeklyDay7" type="checkbox"></td>
					<td class="eventMain"><label for="recWeeklyDay7">Sat</label></td>
				</tr>
			</table>
			</div>
			<div id="monthly" style="visibility: hidden;">
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td class="eventMain"><input style="margin: 3px;" type="radio" checked="checked" value="Day" name="monthlyOption"></td>
				...
				<tr><td colspan="2"><img src="<?echo CalRoot;?>/images/spacer.gif" width="1" height="7" alt="" border="0"></td></tr>
				<tr>
					<td class="eventMain" width="80">City &amp; State:</td>
					<td class="eventMain">
						<input maxlength="75" size="25" type="text" name="locCity" id="locCity" value="" class="eventInput"><span style="color: blue;"> *</span>
					</td>
				</tr>
				<tr><td colspan="2"><img src="<?echo CalRoot;?>/images/spacer.gif" width="1" height="7" alt="" border="0"></td></tr>
				<tr>
					<td class="eventMain" width="80">Country:</td>
					<td class="eventMain">
						<?
							$state = $defaultState;
							include('includes/selectCountry.php');
	...
	<?
		...
		?>
			...
			?>
			Your event will be processed shortly and you will receive an update on the status of your event(s).<br><br>
