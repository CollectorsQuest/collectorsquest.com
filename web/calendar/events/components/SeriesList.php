...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<?php
		...
		echo "<a href=\"" . CalRoot . "/\" class=\"eventMain\">&laquo;&laquo;&nbsp;View This Week's Events</a>";
		...
		if(hasRows($result)){
			...
			while($row = mysql_fetch_row($result)){
				if($curTitle != $row[1]){
					$curTitle = $row[1];?>	
					<tr><td colspan="3"><img src="<?echo CalRoot;?>/images/spacer.gif" width="1" height="10" alt="" border="0"></td></tr>
					<tr>
