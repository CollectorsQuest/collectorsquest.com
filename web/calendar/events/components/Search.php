					...
					<td>
						...
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td>&nbsp;<a href="javascript:;" onclick="caly.select(document.eventSearch.startDate,'anchor1','MM/dd/yyyy'); return false;" name="anchor1" id="anchor1"><img src="<?echo CalRoot;?>/images/datepicker/cal.gif" width="16" height="16" border="0" alt=""></a>&nbsp;</td>
								...
								<td>&nbsp;<a href="javascript:;" onclick="caly.select(document.eventSearch.endDate,'anchor2','MM/dd/yyyy'); return false;" name="anchor2" id="anchor2"><img src="<?echo CalRoot;?>/images/datepicker/cal.gif" width="16" height="16" border="0" alt=""></a>&nbsp;</td>
							</tr>
						</table>
					...
					<td class="eventMain">
						<table cellpadding="0" cellspacing="0" border="0">
							...
							<?php
								...
								?>
									<td class="eventMain"><input style="margin: 4px" type="checkbox" name="catID[]" id="catID_<?echo $row[0];?>" value="<?echo $row[0];?>"></td>
									<td class="eventMain"><img align="absmiddle" src="<?echo CalRoot;?>/images/color_image.php?width=20&height=12&color=<?echo $urlcolor;?>" class="categorybox" border="0"><label style="color: <?echo $row[6];?>;" for="catID_<?echo $row[0];?>"><?echo cOut($row[1]);?></label>&nbsp;&nbsp;</td>
								<?
									$cnt = $cnt + 1;
								}//end while
							?>
