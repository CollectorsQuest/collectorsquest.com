	...
	<table cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			<td colspan="2">
				<table cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td class="main"><input style="margin: 4px;" type="checkbox" name="cookieme" id="cookieme" <?if(isset($_COOKIE["hc_favorites"])){echo "CHECKED";}?>></td>
			...
			<td class="eventMain">
				...
				<?php
					...
					while($row = mysql_fetch_row($result)){
						...
						?>
							<td class="eventMain"><input style="margin: 4px;" <?if($row[7] != ''){echo "checked";}//end if?> type="checkbox" name="catID[]" id="catID_<?echo $row[0];?>" value="<?echo $row[0];?>"></td>
