...
if (Modernizr.isproduction)
{
  ...
  window.onload = function ()
  {
    ...
    {
      _server_load_time = parseInt(_server_load_time / 100, 10) * 100;
      _gaq.push(['_setCustomVar', 1, 'serverLoadTime', _server_load_time, 3]);
    }

    _gaq.push(
      ['_setCustomVar', 2, 'pageLoadTime', parseInt(_page_load_time / 100, 10) * 100, 3],
